...
html{font-size:15px;}
.navbar * {margin: 0 auto; font-family: 'Jeju Gothic', sans-serif; font-size: 1rem; color:white; z-index:1;}
.navbar {display: flex; justify-content: space-between; align-items: center;
		text-align: center; padding:0; margin:0 auto; z-index:1;
		font-family: 'Jeju Gothic', sans-serif; font-size: 1rem; color:white; z-index:1;}
...
.navbar ul li:hover .submenu a {color:white;}
...
/*서브메뉴*/
.submenu {overflow:hidden; position:absolute; left: 0; right: 0; width: 100%; background-color: rgba(255,255,255,0.3);
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">	<!-- 마우스 우클릭, 텍스트 블럭지정 복사, 드래그 금지 -->
	<div class='outer-div' oncontextmenu='return false'>
	  <div class='inner-div'>
	    ...
	    <img src="${pageContext.request.contextPath}/images/nol/logo_wh.png" width="100%" alt="logo"></a>
	  </div>
	</div>
    <nav class="navbar">
